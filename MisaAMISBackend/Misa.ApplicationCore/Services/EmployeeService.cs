...
namespace Misa.ApplicationCore
{
    public class EmployeeService : BaseService<Employee>, IEmployeeService
    {
        ...
        public ServiceResult GetEmployeeFilterPaging(string search_data, int pageIndex, int pageSize)
        {
            try
            {
                var serviceResult = new ServiceResult();
                serviceResult.Data = _employeeRepository.GetEmployeeFilterPaging(search_data, pageIndex, pageSize);
